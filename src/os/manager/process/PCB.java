...
public class PCB {
    ...
    // 就绪
    public static final String STATUS_WAIT="就绪";

    // 运行
    public static final String STATUS_RUN="运行";

    // 阻塞
    public static final String STATUS_BLOCK="阻塞";

    // 闲逛
    public static final String STATUS_HANG_OUT="闲逛";
